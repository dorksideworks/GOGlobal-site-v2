...
function GOFoundation() {
  return (
    <div id="FoundationSection" class="flex flex-col align-center justify-center lg:pb-10 mt-40">
        ...
        <p class="text-gray-300 pt-5 wrapper mx-auto"> Contribute to a greater cause and help those in need. Together, we can change lives With providing an educational platform as one of GO Global’s services, helping non-profit organizations who share the same values is the goal of the GO Foundation.</p>
