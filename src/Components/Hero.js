        ...
        <div class="relative isolate px-6 pt-5 md:pt-14 lg:pt-14 lg:px-8 mb-20">
          ...
          <div id="HeroSection" class="mx-auto max-w-3xl pt-20 sm:pt-20 lg:pt-40">
              ...
              <div class="text-center">
                <h1 class="text-4xl font-bold tracking-tight dark:text-white text-slate-900 sm:text-6xl mb-0 md:mb-40 lg:mb-40"> {t("Hero.title")} </h1>
                ...
                <div class="mt-9"> 
                    ...
                    <Timeline
                      target={
                        <div class="relative">
                          ...
                          <img ref={el => {laptopItem = el}} alt="GO GLOBAL DIGITAL SOLUTION" class="laptop w-100 relative" src='/ASSETS/hero/hero-laptop.png'></img>
                        </div>
                      }
                    >
                  ...
                  <Timeline totalProgress={progress} paused>
                    ...
                    <Timeline
                      target={
                        <div class="hero-gradient bg-gradient-to-t dark:from-slate-900  from-slate-50 absolute left-0 w-full h-32 isolate"></div>
                      }
                    >
